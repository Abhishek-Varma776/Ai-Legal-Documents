...
async function generatePDFReport(analysis: any, format: string) {
  ...
  const mockPDFContent = btoa(`
LexiExplain Analysis Report
===========================
...
Generated by LexiExplain - AI Legal Document Simplifier
  `)
  ...
  try {
    ...
    switch (format) {
      case "pdf":
        ...
        filename = `lexiexplain-analysis-${Date.now()}.pdf`
        break
...
Generated by LexiExplain - AI Legal Document Simplifier
        `)
        mimeType = "text/plain"
        filename = `lexiexplain-analysis-${Date.now()}.txt`
        break
